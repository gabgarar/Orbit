...
const ERROR_MESSAGES = Object.freeze({
    ...
    ADMIN_PASSWORD_RECOVERY_UNAVAILABLE: "Esta cuenta todavía no dispone de recuperación administrativa. No se ha cambiado nada: el usuario debe iniciar sesión y actualizar su contraseña una vez antes de poder restablecerla desde aquí.",
    ACCOUNT_PASSWORD_RESET: "La contraseña de esta cuenta fue restablecida por la administración. Inicia sesión de nuevo con la contraseña nueva.",
    ACCOUNT_PASSWORD_CHANGE_IN_PROGRESS: "La contraseña se está actualizando localmente. Espera unos instantes e inténtalo de nuevo.",
