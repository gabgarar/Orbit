...
export const selectOptions = { size_mode: ["visual", "physical"], level: ["debug", "info", "warn", "error", "silent"], antialias_mode: ["off", "fxaa", "msaa"], quality: ["low", "medium", "high"], output_format: ["webm", "mp4"], language: ["es", "en"], theme: ["dark", "light"] };
export const checkboxes = new Set(["future_show", "ground_track_show", "use_3d_model", "enabled", "show_top_clock", "sky_atmosphere", "globe_lighting", "stars_enabled"]);
