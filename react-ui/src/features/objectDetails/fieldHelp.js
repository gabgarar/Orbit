...
const FIELD_HELP = Object.freeze({
    ...
    "fuente eop": "Diagnóstico de la instantánea EOP global disponible para la rotación terrestre del instante mostrado. No sustituye al archivo ERP adjunto al producto ni habilita por sí solo una conversión SP3 estricta a ECI.",
    "cobertura eop": "Intervalo UTC que el diagnóstico EOP global declara válido. Orbit solo lo presenta como local cuando cubre el instante SP3 consultado.",
    "aviso eop": "Aviso de que no existe una instantánea EOP global aplicable al instante mostrado. La visualización usa una rotación ITRF nominal; no modifica ni reemplaza el ERP del producto.",
