...
export default function NewProjectForm({ onClose }) {
    ...
    const submit = (event) => {
        ...
        if (!result.accepted) {
            setSubmitError("El visor no está disponible. Recarga la aplicación para volver a intentarlo.");
            return;
        }
        onClose();
    };
