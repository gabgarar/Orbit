...
| [Boletines IERS A/B y ERP IGS](bulletins.md) | ERP disponible como auxiliar de importación GNSS; Bulletin A/B sin importador directo. | Un ERP local asociado permite ITRF → ECI; las fuentes rápidas remotas siguen requiriendo snapshot y procedencia explícitos. |
