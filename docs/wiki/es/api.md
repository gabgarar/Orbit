...
- :material-server-network: **Entender el gateway**

  Runtime, persistencia y supervisión de servicios.

  [Ir al gateway →](gateway.md)

- :material-function-variant: **Validar la procedencia**

  Marcos, datos de referencia y políticas estrictas.

  [Ir a internals →](internals.md)
