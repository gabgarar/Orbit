...
| --- | --- |
| Gateway | JSON con límite de 25 MB; la importación GNSS usa su ruta aislada de 90 MB; errores de sintaxis `400`, tamaño `413`; sanitización de configuración y nombres de archivo de catálogo. |
