...
| [IERS Bulletin A](https://maia.usno.navy.mil/products/bulletin-a) / IGS ERP | Rapid EOP, predictions, or products paired with SP3. | Not currently imported; a future local and versioned route, never an automatic fallback. |
