...
| Precise GNSS SP3/CLK products | Durable local SP3 import with optional CLK and IGS/CDDIS, MGEX, or ESA NSO provenance. | [Precise GNSS products](../formats/precise-products.md) |
...
| Precision OEM operational load | Not exposed by UI, gateway, or public API. | Treating a Python reader as a product route. SP3/CLK has its own documented local route. |
